...
class _NewCardState extends State<NewCard> {
  ...
  void _saveData() async {
    ...
    try {
      final newCustumer = await _reposetory.addCustumer(
        AddCustomerModel(name: inputName, phone: phoneName),
      );
      setState(() {
      ...
      setState(() => _errormsg = 'Error saving data: something went wrong');
    } finally {
