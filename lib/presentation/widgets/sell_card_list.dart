...
class SellCardListState extends State<SellCardList> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_customers.isEmpty) {
      return Center(
        child: Text('Ooh! there is no listing! please add custumers'),
      );
    }
    return Column(
      children: [
        ...
        Expanded(
          child: _filterCustomers.isEmpty
              ? Center(child: Text('No customers  matching your search'))
              : RefreshIndicator(
